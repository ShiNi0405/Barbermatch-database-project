...
### 5.8 Table: FAVOURITES

**Purpose:** Customer favorite barber lists (weak entity)
...
**Unique Constraints:** (customer_id, barber_id)  
**Indexes:** customer_id, barber_id

| Column Name | Data Type | Size | Null | Default | Constraints | Description |
|------------|-----------|------|------|---------|-------------|-------------|
| favourite_id | UUID | - | NO | Auto | PRIMARY KEY | Unique favorite identifier |
| customer_id | UUID | - | NO | - | FOREIGN KEY | Reference to customer (USERS) |
| barber_id | UUID | - | NO | - | FOREIGN KEY | Reference to BARBERS |
| created_at | TIMESTAMP | - | NO | NOW() | - | Favorite creation time |

---

### 5.9 Referential Integrity Constraints
...
| FK_FAV_CUSTOMER | FAVOURITES | customer_id | USERS | user_id | CASCADE | CASCADE |
| FK_FAV_BARBER | FAVOURITES | barber_id | BARBERS | barber_id | CASCADE | CASCADE |
...
| IDX_FAV_CUSTOMER | FAVOURITES | customer_id | B-TREE | Customer favorites list |
